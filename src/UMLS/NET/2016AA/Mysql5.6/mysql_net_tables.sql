...
load data local infile 'SRDEF' into table SRDEF fields terminated by '|' ESCAPED BY '' lines terminated by @LINE_TERMINATION@
...
load data local infile 'SRFIL' into table SRFIL fields terminated by '|' ESCAPED BY '' lines terminated by @LINE_TERMINATION@;
...
load data local infile 'SRFLD' into table SRFLD fields terminated by '|' ESCAPED BY '' lines terminated by @LINE_TERMINATION@;
...
load data local infile 'SRSTR' into table SRSTR fields terminated by '|' ESCAPED BY '' lines terminated by @LINE_TERMINATION@
...
load data local infile 'SRSTRE1' into table SRSTRE1 fields terminated by '|' ESCAPED BY '' lines terminated by @LINE_TERMINATION@;
...
load data local infile 'SRSTRE2' into table SRSTRE2 fields terminated by '|' ESCAPED BY '' lines terminated by @LINE_TERMINATION@;
